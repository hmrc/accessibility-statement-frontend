...
class StatementPageSpec extends WordSpec with Matchers with GuiceOneAppPerSuite {
  "Given any Accessibility Statement for a service, rendering a Statement Page" should {
    ...
    "not include a list item of accessibility problems if accessibility problems is empty" in new Setup {
      ...
      contentAsString(
        statementPageHtml
      ) should not include """<ul class="govuk-list govuk-list--bullet" id="accessibility-problems">"""
    }
  }
  ...
  "Given an Accessibility Statement for a fully accessible service, rendering a Statement Page" should {
    ...
    "should not return information on non compliance if milestones are empty" in new Setup {
      ...
      contentAsString(
        statementPageHtml
      ) should not include """<h3 class="govuk-heading-m">Non-accessible content</h3>"""
      contentAsString(
        statementPageHtml
      ) should not include """<p class="govuk-body">The content listed below is non-accessible for the following reasons.</p>"""
      contentAsString(
        statementPageHtml
      ) should not include """<h4 class="govuk-heading-s">Non-compliance with the accessibility regulations</h4>"""
    }
  ...
  "Given an Accessibility Statement for a non accessible service, rendering a Statement Page" should {
    ...
    "should return HTML with a fixed date for carrying out an assessment" in new Setup {
      ...
      contentAsString(statementPageHtml) should include(
        """<p class="govuk-body">It has not been tested for compliance with WCAG 2.1 AA. The service will book a full accessibility audit by 30 September 2021.</p>"""
      )
    }
  }
  ...
  "Given an accessibility statement that is partially compliant, where only automated testing has been carried out, " +
    "rendering a Statement Page"                                                              should {
      ...
      "return HTML with the date for carrying out a full assessment" in new Setup {
        ...
        contentAsString(statementPageHtml) should include(
          """ <p class="govuk-body">The service will also book a full accessibility audit by 30 September 2021.</p>"""
        )
      }
